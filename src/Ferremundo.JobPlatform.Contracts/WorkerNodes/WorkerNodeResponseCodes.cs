...
public static class WorkerNodeResponseCodes
{
    ...
    public const string WorkerNodeHeartbeatRegistered = "WORKER_NODE_HEARTBEAT_REGISTERED";
    ...
    public const string WorkerNodeInvalidHeartbeatStatus = "WORKER_NODE_INVALID_HEARTBEAT_STATUS";
